...
int CMysqlClient::Connect(const KeyValue& args) {
	...
	ret = mysql_real_connect(&m_db,
		args.at("host"), args.at("user"), args.at("passwd"),
		args.at("db"), atoi(args.at("port")),
		NULL, 0
	);
...
Buffer _mysql_table_::Modify(const _Table_& values)	//TODO:optimize args
{
